...
import { beginningOfThisMonthPlusTwoMonthsUTC, endOfTodayUTC, THIS_MONTH_PLUS_2_MONTHS, OTHER } from '../../shared/util/date.util';
          ...
          root: {
            firstChild: {
              params: {
                ...
                interval: 'hourly',
                page: '1',
                standardRange: THIS_MONTH_PLUS_2_MONTHS
              }
            }
          }
        }
