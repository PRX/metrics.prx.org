...
import { routerParams as downloadParams, episodes, ep0AgentNameRanks } from '../../../testing/downloads.fixtures';
...
describe('Episode Totals Reducer', () => {
  ...
  it('should set loading, loaded, and unset error on episode totals load', () => {
    ...
    const newState = reducer(initialState, ACTIONS.CastleEpisodeTotalsLoad({ guid, group, beginDate, endDate }));
  ...
  it('should include filter in key for geo subdiv', () => {
    ...
    expect(newState.entities[key]).not.toBeNull();
  });
